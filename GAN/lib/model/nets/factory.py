...
def define_3DG(noise_len, input_shape, output_shape, input_nc, output_nc, ngf, which_model_netG, n_downsampling,
  ...
  elif which_model_netG == 'singleview_network_denseUNet_transposed_attention':
    from .generator.dense_generator_multiview import UNetLike_DownStep5_attention
    netG = UNetLike_DownStep5_attention(input_shape=encoder_input_shape[0], encoder_input_channels=encoder_input_nc, decoder_output_channels=output_nc, decoder_out_activation=activation_layer, encoder_norm_layer=encoder_norm_layer, decoder_norm_layer=decoder_norm_layer, upsample_mode='transposed')
  elif which_model_netG == 'singleview_network_denseUNet_transposed_sft':
    from .generator.dense_generator_multiview import UNetLike_DownStep5_sft
    netG = UNetLike_DownStep5_sft(input_shape=encoder_input_shape[0], encoder_input_channels=encoder_input_nc, decoder_output_channels=output_nc, decoder_out_activation=activation_layer, encoder_norm_layer=encoder_norm_layer, decoder_norm_layer=decoder_norm_layer, upsample_mode='transposed')
